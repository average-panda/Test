...
class test:
    ...
    async def mbotcoms(self):
        ...
        Tembed.add_field(name="_______", value="__Additional Information:__\n")
        Tembed.add_field(name="`❔`", value="For additional information type `*help`")
        Tembed.add_field(name="`⚠️`", value="If you are experiencing issues with the music bot, or if the bot is unavailable, contact `average.panda`")
